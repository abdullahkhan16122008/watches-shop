...
const pages = () => {
  ...
  return (
    <>
    <Header />
      <h1 className='my-9 text-5xl font-medium text-center'>All Products</h1>
     <div className='overflow-hidden flex flex-wrap justify-center my-10 w-[95%] justify-self-center'>

      {products.map((item)=>(
        <div className='h-[550px] w-[350px] max-sm:w-[100%] max-sm:justify-self-center border-7 border-white outline-none' key={item._id} data-aos='fade-up' onClick={handleNavigate}>
